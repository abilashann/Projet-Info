...
{
    public:
        Svgfile(std::string _filename = "output.svg", int _width=1500, int _height=1000);
        ~Svgfile();
        ...
        void addRect(double x1, double y1, double largeur, double longeur,std::string colorFill,double thickness, std::string colorStroke);
