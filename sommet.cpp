...
int Sommet::getDist (int i) //retourne la poid de l'arc allant du sommet � un autre sommet de num�ro i
{
    int d=99;
...
bool Sommet::estAdjacentA(int i) //dertmine si on peut aller du sommet au un autre sommet de num�ro i
{
    bool adjacent=false;
    for (auto it : m_adjacents)
        if (it.first->get_id()==i)
