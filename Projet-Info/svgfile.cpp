...
void Svgfile::addRect(double x1, double y1, double largeur, double longeur,std::string colorFill,double thickness, std::string colorStroke)
{

    m_ostrm << "<polygon points=\" "
            << x1 << "," << y1 << " "
            << x1+ longeur << "," << y1 << " "
            << x1+longeur << "," << y1+ largeur << " "
            << x1 << "," << y1+ largeur << " "
            << "\" style=\"fill:" << colorFill
            << ";stroke:" << colorStroke
            << ";stroke-width:" << thickness
